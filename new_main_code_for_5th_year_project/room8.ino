void p_in8(){
 ...
 //shutter put the car room8
  ...
  //pick down the car room8 in parking place/go to same 2nd level from a litte more than 2nd level
...
void p_out8(){
 ...
 //shutter put under the car room8
  shutter.setSpeed(10);
  shutter.step(-2038*2); 
  shutter.step(-230);
  delay(500);
