...
/*******************************************************************/
 ...
 //shutter put the car room4
  ...
  //pick down the car room4 in parking place/go to same 1st level
...
void p_out4(){
 ...
 //shutter put the under car room4
  shutter.setSpeed(10);
  shutter.step(-2038*2); 
  shutter.step(-230);
  delay(500);
